    ...
    extends SimpleTest
{
        ...
        throws Exception
    {
        ...
        key = new DestroyableSecretKeySpec(keyBytes, "GOST3412-2015");
        ...
        throws Exception
    {
        ...
        mac.init(new DestroyableSecretKeySpec(Hex.decode("8899aabbccddeeff0011223344556677fedcba98765432100123456789abcdef"), "GOST3412MAC"));
